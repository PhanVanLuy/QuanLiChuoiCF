...
=======
        ...
        private void btn_Bill_New_Click(object sender, EventArgs e)
        {
            
        }

        private void btn_Bill_Add_Click(object sender, EventArgs e)
        {
        ...
        private void btn_Bill_Update_Click(object sender, EventArgs e)
        {
            
        }

        private void dtgv_Supplier_Material_Click(object sender, EventArgs e)
        {
            LoadMaterialByIDOfSupplier();
        }

        private void dtgv_Supplier_Material_BindingContextChanged(object sender, EventArgs e)
        {
            
        }

        private void dtgv_Supplier_Material_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
           
        }

        private void dtgv_Supplier_Material_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            
        }

        private void dtgv_Supplier_Material_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            LoadMaterialByIDOfSupplier();
        }
        ...
        private void dtgv_Supplier_Material_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            LoadMaterialByIDOfSupplier();
        }
>>>>>>> Stashed changes
